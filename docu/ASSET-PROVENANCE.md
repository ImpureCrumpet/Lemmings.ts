...
| `docu/examples/main.png` | No; documentation only | Recaptured from the current private build using player-supplied game data in August 2026 | Contains rendered commercial game artwork; review before external source distribution | Keep only in the private repository unless permission or a replacement is established |
| `docu/examples/demo_01.png` | No; documentation only | Recaptured from the current private build using player-supplied game data in August 2026 | Contains rendered commercial game artwork; review before external source distribution | Same as above |
| `docu/examples/demo_02.png` | No; documentation only | Recaptured from the current private build using player-supplied game data in August 2026 | Contains rendered commercial game artwork; review before external source distribution | Same as above |
| `docu/examples/setup.png` | No; documentation only | Recaptured from the current private build in August 2026 | Project interface only; no original data is rendered | Retain as current setup documentation |
